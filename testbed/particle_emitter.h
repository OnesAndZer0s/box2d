...
#include "box2d/particle/particle_group.h"
#include "box2d/particle/particle_system.h"
...
class RadialEmitter {
  public:
    ...
    // simulation step.
    int32 Step( const float dt, int32* const particleIndices,
